// Shared FAQ question/answer data — single source for the FAQ page's
// FAQPage JSON-LD block (src/app/faq/page.tsx) and the /md/faq Markdown
// mirror (src/app/md/[slug]/route.ts). Keeps both in sync automatically.
//
// This does not replace the FAQ page's themed, narrative visible sections
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  { question: "Who leads the ceremonies?", answer: "Ceremonies are led by Maestra Dominga and Maestro Raúl in the traditional Shipibo ceremonial lineage. A support team is in the room throughout." },
  { question: "How many ceremonies will I have, and when?", answer: "Ceremonies are held on Monday, Wednesday, and Friday nights. The minimum stay of five nights includes three ceremonies. A Friday start typically means a six-night stay with three ceremonies. The maximum stay of two weeks includes up to six ceremonies." },
  ...
  { question: "Is transport included?", answer: "Yes. We pick you up at the designated city meeting point in Iquitos at 1 PM on the first day of your retreat and bring you to the property by 4x4. Drop-off at Iquitos airport is included for departures after 3 PM on the last day. Airport pickup is not included. Uber is available in Iquitos, but it is smart to bring cash in soles in case Uber is not working or a driver asks for cash. Motor taxis from the airport to hotels in Iquitos usually cost about 30–70 soles." },
  { question: "Is there Wi-Fi at Dreamglade?", answer: "There is no Wi-Fi in guest rooms or anywhere at the centre, by design. Electricity is limited and simple, and the retreat is designed for quiet time away from normal digital life. Most guests find the disconnection is part of what makes the week work. Some cellphone carriers have limited service around the retreat. We have a generator that runs once a day; this is the time to charge your devices." },
  { question: "What food is served?", answer: "The retreat dieta is light, low-salt, plant-forward, and built around what grows here. Rice, sweet potatoes, yuca, grains and fresh fruit. Nothing fried, and no added sugars." },
  { question: "What is a plant dieta?", answer: "A plant dieta is not just a food diet. In the Amazonian tradition, it is a quiet period of simplicity, attention, and relationship with a master plant. At Dreamglade, the healers prepare a small tea or plant decoction from the selected master plant, which may be a tree, vine, or shrub, for the guest to drink, and the guest follows a simple retreat rhythm around that work." },
  { question: "Can I choose which master plant dieta I do?", answer: "Dreamglade offers six traditional master plant dietas: Marosa, Ajo Sacha, Bobinsana, Machinga, Clavo Huasca, and Planta de Vida. The specific plant is discussed and selected with Maestro Raúl based on the guest, their preparation, and what is appropriate once they arrive. It is not usually chosen from a menu in advance." },
  ...
  { question: "Who handles my health information?", answer: "Paul, our integration support specialist." },
  { question: "What about cannabis, alcohol, or recreational substances?", answer: "Alcohol, cannabis, recreational drugs, and other substances may affect preparation and safety. Guests are asked to disclose substance use honestly during the intake process so Paul can review the situation and ask follow-up questions if needed." },
  { question: "What does the pre-retreat dieta involve?", answer: "For at least two weeks before arrival, guests are expected to come off processed foods, pork, red meat, alcohol, recreational substances, fermented foods, caffeine and limit salt and sugar. Walks, rest, and hydration are recommended. Most guests find it helpful to spend the last week noting what they are bringing — an intention they can put in writing." },
  { question: "What should I bring?", answer: "We recommend bringing loose, light clothing for ceremony, natural insect repellent, sandals, a refillable water bottle, a notebook, and a flashlight with a red light feature because it is less disruptive for other guests. All toiletries, including soaps and toothpaste, should be natural. Paul will give you more details once you are confirmed." },
  { question: "Are there other activities besides ceremony?", answer: "Yes. Plant baths, plant dietas, breathwork, jungle trails to explore and sauna are included." },
  { question: "What if I get sick during ceremony?", answer: "Purging — vomiting, sometimes diarrhea — is common and is part of the work. Each guest has their own bucket within arm's reach, and the support team is in the room throughout the night. Nothing about it is treated as shameful." },
  { question: "I am worried about being without my phone. Is that a problem?", answer: "It is often one of the bigger adjustments at the start of the retreat, especially in the first couple of days. But most guests find that once they settle in, the quiet becomes part of what they value most. If you need to check in with a family member to let them know you are safe, please let a team member know and we will help make that happen." },
  { question: "When can I arrive at Dreamglade?", answer: "Dreamglade does not run fixed-date group retreats. You can start your stay on a Monday or a Friday. A Wednesday start is sometimes possible under special conditions." },
  { question: "Can I leave the property during my stay?", answer: "No. Once you arrive at Dreamglade, you stay on the land for the full retreat. We do not run day trips out from the centre." },
];
