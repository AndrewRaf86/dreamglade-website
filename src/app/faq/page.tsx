        ...
        <div className="container">
          ...
          <div className="faq-list">
            <FAQItem question="Who leads the ceremonies?">
              <p>Ceremonies are led by Maestra Dominga and Maestro Raul in the Shipibo tradition. A small support team is in the room throughout.</p>
            </FAQItem>
            ...
            <FAQItem question="How long does a ceremony last?">
              <p>Quiet time begins at 6 PM and ceremony begins at 7 PM. Each ceremony runs five to six hours, with the healers and a small support team present throughout.</p>
            </FAQItem>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <FAQItem question="Are there other activities besides ceremony?">
              <p>Yes. Plant baths, yoga, breathwork, sauna, and sweat lodge are included. Kambo can be added for an additional 100 soles. Plant dietas — a deeper, longer commitment to a single teacher plant — are available on request.</p>
            </FAQItem>
          </div>
        </div>
      </section>
