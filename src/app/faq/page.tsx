...
const faqJsonLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Who runs Dreamglade?", acceptedAnswer: { "@type": "Answer", text: "Dreamglade was founded by Stacy Povey in 2013 and later came under the care of Wade Bucher and Clarisa Gutierrez in 2023. Paul reviews every application personally." } },
    ...
    { "@type": "Question", name: "Where is Dreamglade located?", acceptedAnswer: { "@type": "Answer", text: "Dreamglade is near Moralillo, under an hour's drive from Iquitos in the Peruvian Amazon. The property is 25 hectares of rainforest lakeside." } },
    { "@type": "Question", name: "Is Dreamglade good for first-time ayahuasca guests?", acceptedAnswer: { "@type": "Answer", text: "Yes. Many guests come to Dreamglade for their first ayahuasca experience. The small group of no more than ten, the traditional Shipibo-led ceremonies, and Paul's personal screening and preparation are designed to make a first time feel safe and well supported." } },
    ...
    { "@type": "Question", name: "Who leads the ceremonies?", acceptedAnswer: { "@type": "Answer", text: "Ceremonies are led by Maestra Dominga and Maestro Raúl, a married Shipibo ceremonial couple from Vista Alegre, a village upriver from Pucallpa, with more than 40 years of life, family, and service to their community. A support team is in the room throughout." } },
    ...
    { "@type": "Question", name: "How long does a ceremony last?", acceptedAnswer: { "@type": "Answer", text: "Preparation for ceremony begins at 6pm. Ceremony starts shortly after. Each ceremony runs five to six hours, with the healers and a support team present throughout." } },
    { "@type": "Question", name: "How many ceremonies do you recommend?", acceptedAnswer: { "@type": "Answer", text: "The minimum is three ceremonies. For any deeper, longer-arc work, we strongly recommend five or six." } },
    ...
    { "@type": "Question", name: "Is it okay to participate in ceremony during my menstrual cycle?", acceptedAnswer: { "@type": "Answer", text: "Yes, this is a common concern and it is safe. We have had many guests come and join during that time of the month." } },
    { "@type": "Question", name: "How does the application process work?", acceptedAnswer: { "@type": "Answer", text: "The first step is a short inquiry — no medical history. Paul reads every one personally. If it looks like a fit, he writes back to start a conversation. Full registration and a signed agreement come later, by email, before your arrival date is confirmed." } },
    { "@type": "Question", name: "How much does it cost?", acceptedAnswer: { "@type": "Answer", text: "Pricing is per person, per day, and depends on the tambo type: $200 USD for a communal tambo, $210 USD for a two-person tambo, and $220 USD for a private tambo. Current pricing is also shown in the pricing section of the home page." } },
    { "@type": "Question", name: "What is included in the price?", acceptedAnswer: { "@type": "Answer", text: "Accommodation in a private, two-person, or communal thatched tambo, all meals, ceremonies, plant dieta, breathwork, sauna, and integration support before and after your stay. Group transport from the designated city meeting point in Iquitos on the first day of your retreat and drop-off to the city of Iquitos and Iquitos airport are included for flights after 3 PM. Not included: international and domestic flights, airport pickup on arrival, travel insurance, visas, and vaccinations." } },
    { "@type": "Question", name: "Should I book my flights before my application is confirmed?", acceptedAnswer: { "@type": "Answer", text: "No — we recommend waiting until Paul has reviewed your application and confirmed your dates before you book flights. Once your place is confirmed and your deposit is in, you can book with confidence." } },
    { "@type": "Question", name: "What is the deposit and cancellation policy?", acceptedAnswer: { "@type": "Answer", text: "A 50% deposit confirms your place. Cancellations within seven days get your deposit back minus a $100 cancellation fee. Specifics are confirmed in the Stage 2 registration and agreement." } },
    { "@type": "Question", name: "Is transport included?", acceptedAnswer: { "@type": "Answer", text: "Yes. We pick you up at the designated city meeting point in Iquitos at 1 PM on the first day of your retreat and bring you to the property by 4x4. Drop-off at Iquitos airport is included for departures after 3 PM on the last day. Airport pickup is not included. Uber is available in Iquitos, but it is smart to bring cash in soles in case Uber is not working or a driver asks for cash. Motor taxis from the airport to hotels in Iquitos usually cost about 30–70 soles." } },
    { "@type": "Question", name: "Is there Wi-Fi at Dreamglade?", acceptedAnswer: { "@type": "Answer", text: "There is no Wi-Fi in guest rooms or anywhere at the centre, by design. Electricity is limited and simple, and the retreat is designed for quiet time away from normal digital life. Most guests find the disconnection is part of what makes the week work. Some cellphone carriers have limited service around the retreat. We have a generator that runs once a day; this is the time to charge your devices." } },
    { "@type": "Question", name: "What food is served?", acceptedAnswer: { "@type": "Answer", text: "The retreat dieta is light, low-salt, plant-forward, and built around what grows here. Rice, sweet potatoes, yuca, grains and fresh fruit. Nothing fried, and no added sugars." } },
    { "@type": "Question", name: "What is a plant dieta?", acceptedAnswer: { "@type": "Answer", text: "A plant dieta is not just a food diet. In the Amazonian tradition, it is a quiet period of simplicity, attention, and relationship with a master plant. At Dreamglade, the healers prepare a small tea or plant decoction from the selected master plant, which may be a tree, vine, or shrub, for the guest to drink, and the guest follows a simple retreat rhythm around that work." } },
    { "@type": "Question", name: "Can I choose which master plant dieta I do?", acceptedAnswer: { "@type": "Answer", text: "Dreamglade offers five traditional master plant dietas: Marosa, Ajo Sacha, Bobinsana, Clavo Huasca, and Planta de Vida. The specific plant is discussed and selected with Maestro Raúl based on the guest, their preparation, and what is appropriate once they arrive. It is not usually chosen from a menu in advance." } },
    { "@type": "Question", name: "Does Dreamglade follow up after the retreat?", acceptedAnswer: { "@type": "Answer", text: "Yes. Paul reaches out within a month of you leaving to see how the landing has been, and ongoing support by email is available if you want it." } },
    { "@type": "Question", name: "Should I stay in Iquitos after the retreat?", acceptedAnswer: { "@type": "Answer", text: "If you can, yes — one or two nights in Iquitos before flying home is worth it. It gives you a softer re-entry: simple food and time to put words to what happened before the bigger noise of normal life starts again." } },
    { "@type": "Question", name: "Can I come on my own?", acceptedAnswer: { "@type": "Answer", text: "No. All bookings are handled through the website or by email with Paul. You cannot show up and join a retreat without going through the booking process." } },
    { "@type": "Question", name: "Is Dreamglade suitable for women traveling alone?", acceptedAnswer: { "@type": "Answer", text: "Yes. Many guests come on their own, including women traveling solo. Dreamglade is a small retreat with personal screening, continuous staff presence, and a calm, respectful setting designed to help guests feel at ease." } },
    { "@type": "Question", name: "I use cannabis regularly. Can I still attend?", acceptedAnswer: { "@type": "Answer", text: "Yes, but be honest about it on your application. For habitual users — daily use over a long period — we recommend stopping cannabis four to six weeks before the retreat and staying off it for two weeks afterward." } },
    ...
    { "@type": "Question", name: "Who handles my health information?", acceptedAnswer: { "@type": "Answer", text: "Paul, our integration support specialist." } },
    ...
    { "@type": "Question", name: "What does the pre-retreat dieta involve?", acceptedAnswer: { "@type": "Answer", text: "For at least two weeks before arrival, guests are expected to come off processed foods, pork, red meat, alcohol, recreational substances, fermented foods, caffeine and limit salt and sugar. Walks, rest, and hydration are recommended. Most guests find it helpful to spend the last week noting what they are bringing — an intention they can put in writing." } },
    { "@type": "Question", name: "What should I bring?", acceptedAnswer: { "@type": "Answer", text: "We recommend bringing loose, light clothing for ceremony, natural insect repellent, sandals, a refillable water bottle, a notebook, and a flashlight with a red light feature because it is less disruptive for other guests. All toiletries, including soaps and toothpaste, should be natural. Paul will give you more details once you are confirmed." } },
    { "@type": "Question", name: "Are there other activities besides ceremony?", acceptedAnswer: { "@type": "Answer", text: "Yes. Plant baths, plant dietas, breathwork, jungle trails to explore and sauna are included." } },
    { "@type": "Question", name: "What if I get sick during ceremony?", acceptedAnswer: { "@type": "Answer", text: "Purging — vomiting, sometimes diarrhea — is common and is part of the work. Each guest has their own bucket within arm's reach, and the support team is in the room throughout the night. Nothing about it is treated as shameful." } },
    { "@type": "Question", name: "I am worried about being without my phone. Is that a problem?", acceptedAnswer: { "@type": "Answer", text: "It is often one of the bigger adjustments at the start of the retreat, especially in the first couple of days. But most guests find that once they settle in, the quiet becomes part of what they value most. If you need to check in with a family member to let them know you are safe, please let a team member know and we will help make that happen." } },
        ...
        <div className="container">
          ...
          <div className="faq-list">
            <FAQItem question="Who leads the ceremonies?">
              <p>Ceremonies are led by Maestra Dominga and Maestro Raúl, a married Shipibo ceremonial couple from Vista Alegre, a village upriver from Pucallpa, with more than 40 years of life, family, and service to their community. A support team is in the room throughout.</p>
            </FAQItem>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            <FAQItem question="How much does it cost?">
              <p>Pricing is per person, per day, and depends on the tambo type: $200 USD for a communal tambo, $210 USD for a two-person tambo, and $220 USD for a private tambo. Current pricing is also shown in the <TrackedLink href="/#pricing" style={{ color: "var(--gold)", borderBottom: "1px solid var(--gold)" }} event="Pricing Click" properties={{ location: "faq-page", destination: "pricing" }}>pricing section</TrackedLink> of the home page.</p>
            </FAQItem>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <FAQItem question="Can I choose which master plant dieta I do?">
              <p>Dreamglade offers five traditional master plant dietas: Marosa, Ajo Sacha, Bobinsana, Clavo Huasca, and Planta de Vida. The specific plant is discussed and selected with Maestro Raúl based on the guest, their preparation, and what is appropriate once they arrive. It is not usually chosen from a menu in advance. See <TrackedLink href="/master-plants" event="Plants Click" properties={{ location: "faq-page", destination: "master-plants" }}>Master Plants</TrackedLink> for what each one is known for.</p>
            </FAQItem>
          </div>
        </div>
      </section>
