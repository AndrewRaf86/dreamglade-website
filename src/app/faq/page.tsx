...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How many ceremonies do you recommend?", acceptedAnswer: { "@type": "Answer", text: "The minimum is three ceremonies, which is enough to see whether ayahuasca is something you want to work with. For any deeper, longer-arc work, we strongly recommend five or six." } },
    ...
    { "@type": "Question", name: "What is included in the price?", acceptedAnswer: { "@type": "Answer", text: "Accommodation in a private, two-person, or communal thatched tambo, all meals, ceremonies, plant dieta, breathwork, sauna, and integration support before and after your stay. Group transport from the designated city meeting point in Iquitos on the first day of your retreat and drop-off at Iquitos airport at the end are included for flights after 3 PM. Not included: international and domestic flights, airport pickup on arrival, travel insurance, visas, and vaccinations." } },
    ...
    { "@type": "Question", name: "What does the pre-retreat dieta involve?", acceptedAnswer: { "@type": "Answer", text: "For at least two weeks before arrival, we suggest you limit pork, red meat, alcohol, recreational substances, fermented foods, salt, and sugar. The week before, simpler still. Walks, rest, and hydration. Most guests find it helpful to spend the last week noting what they are bringing — an intention they can put in writing." } },
    { "@type": "Question", name: "What should I bring?", acceptedAnswer: { "@type": "Answer", text: "We recommend bringing loose, light clothing for ceremony, insect repellent, sandals, a refillable water bottle, a notebook, and a flashlight with a red light feature because it is less disruptive for other guests. All toiletries, including soaps and toothpaste, should be natural. Paul will give you more details once you are confirmed." } },
    { "@type": "Question", name: "Are there other activities besides ceremony?", acceptedAnswer: { "@type": "Answer", text: "Yes. Plant baths, breathwork, and sauna are included. Plant dietas — a deeper, longer commitment to a single teacher plant — are chosen for you by Maestro Raúl upon your arrival." } },
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <FAQItem question="How many ceremonies do you recommend?">
              <p>The minimum is three ceremonies, which is enough to see whether ayahuasca is something you want to work with. For any deeper, longer-arc work, we strongly recommend five or six.</p>
            </FAQItem>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            <FAQItem question="What does the pre-retreat dieta involve?">
              <p>For at least two weeks before arrival, we suggest you limit pork, red meat, alcohol, recreational substances, fermented foods, salt, and sugar. The week before, simpler still. Walks, rest, and hydration. Most guests find it helpful to spend the last week noting what they are bringing — an intention they can put in writing.</p>
            </FAQItem>
            <FAQItem question="What should I bring?">
              <p>We recommend bringing loose, light clothing for ceremony, insect repellent, sandals, a refillable water bottle, a notebook, and a flashlight with a red light feature because it is less disruptive for other guests. All toiletries, including soaps and toothpaste, should be natural. Paul will give you more details once you are confirmed.</p>
            </FAQItem>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <FAQItem question="What is included in the price?">
              <p>Accommodation in a private, two-person, or communal thatched tambo, all meals, ceremonies, plant dieta, breathwork, sauna, and integration support before and after your stay. Group transport from the designated city meeting point in Iquitos on the first day of your retreat and drop-off at Iquitos airport at the end are included for flights after 3 PM.</p>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <FAQItem question="Is there Wi-Fi or electricity in my room?">
              <p>No. There is no electricity or Wi-Fi in guest rooms or anywhere at the centre, by design. Electricity is limited and simple, and the retreat is designed for quiet time away from normal digital life. Most guests find the disconnection is part of what makes the week work.</p>
            </FAQItem>
            ...
            <FAQItem question="Are there other activities besides ceremony?">
              <p>Yes. Plant baths, breathwork, and sauna are included. Plant dietas — a deeper, longer commitment to a single teacher plant — are chosen for you by Maestro Raúl upon your arrival.</p>
            </FAQItem>
          </div>
        </div>
      </section>
