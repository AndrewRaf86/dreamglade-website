...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Who leads the ceremonies?", acceptedAnswer: { "@type": "Answer", text: "Ceremonies are led by Maestra Dominga and Maestro Raúl in the traditional Shipibo ceremonial lineage. A support team is in the room throughout." } },
    ...
    { "@type": "Question", name: "How much does it cost?", acceptedAnswer: { "@type": "Answer", text: "Current pricing is shown in the pricing section of the home page." } },
    ...
    { "@type": "Question", name: "Can I choose which master plant dieta I do?", acceptedAnswer: { "@type": "Answer", text: "Dreamglade offers six traditional master plant dietas: Marosa, Ajo Sacha, Bobinsana, Machinga, Clavo Huasca, and Planta de Vida. The specific plant is discussed and selected with Maestro Raúl based on the guest, their preparation, and what is appropriate once they arrive. It is not usually chosen from a menu in advance." } },
