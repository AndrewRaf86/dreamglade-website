    ...
    <>
      ...
      <section className="section section--cream">
        <div className="container">
          ...
          <div className="grid-3">
            <article className="col-item">
              <img src="/images2/dreamglade-outside-single-tambo.jpeg" alt="Private tambo cabin surrounded by rainforest at Dreamglade" style={{ aspectRatio: "4/3", objectFit: "cover", width: "100%" }} />
